...
CONTRACT_ADDRESS_1 = '0x57a0526fbce4183d146be2ef31e16969dacf51bf'
CONTRACT_ADDRESS_2 = '0xfc12342dcf4dc690e03325cc549c1272ea342092'
CONTRACT_FAKE_ADDRESS = '0x343deaf9453bcfde30323237abdde4343dff2323'

with open('solidity/%s/abi.json' % CONTRACT_ADDRESS_1, 'rb') as json_abi:
    CONTRACT_ABI_1 = json_abi.read()

with open('solidity/%s/VertogasRegistrar.json' % CONTRACT_ADDRESS_2, 'rb') as json_abi:
    CONTRACT_ABI_2 = json_abi.read()
...
EVENT_ABIS = [
    ...
    for abi in json.loads(CONTRACT_ABI_1.decode()) if abi['type'] == 'event'
]
